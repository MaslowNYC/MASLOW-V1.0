...
const ImpactPage = () => {
  return (
    <div className="min-h-screen bg-[#F5F1E8]">
      <Helmet>
        <title>Our Impact | Maslow NYC</title>
      ...
      <div className="bg-[#3B5998] py-24 px-4 text-center">
        ...
        >
          The Maslow Impact Protocol
        </motion.h1>
      </div>

       {/* Protocol Definition Section */}
       <section className="py-16 px-4 bg-white border-b border-[#3B5998]/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <p className="text-xl md:text-2xl text-[#3B5998] font-serif leading-relaxed italic">
              "Maslow is a for-profit entity, <span className="text-[#C5A059] font-bold not-italic">Certified WBE (Women-Owned Business Enterprise)</span>, structured as a Public Benefit Corporation to serve the city."
            </p>
          </motion.div>
        </div>
      </section>
