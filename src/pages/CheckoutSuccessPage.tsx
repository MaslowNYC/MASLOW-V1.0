    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-[#FAF4ED] px-4 py-12">
      ...
      >
        <div className="p-12 text-center">
          ...
          <h1 className="text-4xl font-serif font-bold text-[#286BCD] mb-4">
            Payment Successful!
          </h1>

          <p className="text-lg text-[#286BCD]/70 mb-8 max-w-lg mx-auto">
          ...
          <div className="bg-[#FAF4ED] rounded-xl p-6 mb-8 text-left border border-[#286BCD]/10">
            <h3 className="font-bold text-[#286BCD] mb-2 uppercase tracking-wide text-sm">Next Steps</h3>
            <ul className="space-y-2 text-[#286BCD]/80 text-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/store">
              <Button className="w-full sm:w-auto bg-[#286BCD] hover:bg-[#2d4475] text-[#FAF4ED] px-8 py-6 font-bold tracking-wider">
                <ShoppingBag className="w-4 h-4 mr-2" />
                Continue Shopping
              </Button>
            </Link>
            <Link to="/">
              <Button variant="outline" className="w-full sm:w-auto border-[#286BCD] text-[#286BCD] hover:bg-[#286BCD]/10 px-8 py-6 font-bold tracking-wider">
        ...
        <div className="bg-[#286BCD] p-4 text-center">
