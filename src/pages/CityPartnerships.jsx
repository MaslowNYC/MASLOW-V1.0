...
import { Mail, Building2, Users, TrendingUp, MapPin, CheckCircle2 } from 'lucide-react';

const CityPartnerships = () => {
  return (
    <div className="min-h-screen bg-[#F5F0E6]">
      ...
      <section className="py-8 px-4 bg-[#F5F0E6] border-t-2 border-[#3C5999]/10">
        <div className="max-w-4xl mx-auto text-center text-sm text-gray-600">
          <p>
            Maslow NYC is a private company with a nonprofit arm (The Maslow Project). 
...
export default CityPartnerships;
