    ...
    <div className="min-h-screen bg-[#FAF4ED]">
      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        >
          {/* Section 1 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">1. Who We Are</h2>
          ...
          {/* Section 2 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">2. Information We Collect</h2>
          ...
          {/* Section 3 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">3. How We Use Your Information</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 4 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">4. Your Preferences and Sensitive Information</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 5 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">5. Data Retention</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 6 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">6. Security</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 7 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">7. Third-Party Services</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 8 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">8. Your Rights</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 9 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">9. Children</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 10 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">10. Changes to This Policy</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          <section className="border-t border-[#286BCD]/20 pt-8">
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">11. Contact</h2>
