...
const PrivacyPolicyPage = () => {
  useEffect(() => {
    ...
    script.src = 'https://policies.termageddon.com/api/embed/Y1dvcldESmlSalk0VG01dFkxRTlQUT09.js';
    script.async = true;
  ...
  return (
    <div className="min-h-screen bg-[#FAF4ED]">
      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        >
          <div
            id="Y1dvcldESmlSalk0VG01dFkxRTlQUT09"
            className="policy_embed_div text-[#286BCD]"
          >
            Please wait while the policy is loaded. If it does not load, please{' '}
            <a
              rel="nofollow"
              href="https://policies.termageddon.com/api/policy/Y1dvcldESmlSalk0VG01dFkxRTlQUT09"
              target="_blank"
