    ...
    <div className="min-h-screen bg-[#FAF4ED]">
      ...
      <div className="bg-[#286BCD] py-16">
        <div className="container mx-auto px-4">
          ...
          <motion.p
            ...
            className="text-[#C49F58] text-center mt-2 font-medium"
          >
      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        >
          {/* Section 1 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">1. Acceptance of Terms</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 2 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">2. About Maslow</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 3 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">3. Account Registration</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 4 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">4. Credits and Passes</h2>
            <ul className="space-y-3 text-[#286BCD]/80 leading-relaxed">
              ...
              <li className="flex gap-2">
                ...
                <span>Refund requests for unused credits may be submitted to{' '}
                  <a href="mailto:hello@maslow.nyc" className="text-[#C49F58] hover:underline">hello@maslow.nyc</a>
          ...
          {/* Section 5 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">5. Membership</h2>
            <ul className="space-y-3 text-[#286BCD]/80 leading-relaxed">
              <li className="flex gap-2">
                <span className="text-[#C49F58] font-bold">•</span>
          ...
          {/* Section 6 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">6. Bookings and Queue</h2>
            <ul className="space-y-3 text-[#286BCD]/80 leading-relaxed">
              <li className="flex gap-2">
                <span className="text-[#C49F58] font-bold">•</span>
          ...
          {/* Section 7 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">7. Personal Preferences</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 8 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">8. Conduct</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 9 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">9. Limitation of Liability</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 10 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">10. Changes to These Terms</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 11 */}
          <section>
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">11. Governing Law</h2>
            <p className="text-[#286BCD]/80 leading-relaxed">
          ...
          {/* Section 12 */}
          <section className="border-t border-[#286BCD]/20 pt-8">
            <h2 className="text-2xl font-serif font-bold text-[#286BCD] mb-4">12. Contact</h2>
            <div className="text-[#286BCD]/80 leading-relaxed">
              <p className="font-semibold text-[#286BCD]">Maslow LLC</p>
              <p>
                <a href="mailto:hello@maslow.nyc" className="text-[#C49F58] hover:underline">hello@maslow.nyc</a>
              </p>
              <p>New York, NY</p>
