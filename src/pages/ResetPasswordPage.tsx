  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#1a1a1a] via-[#2C5F8D] to-[#1a1a1a] flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-[#1a1a1a]/90 backdrop-blur border-[#D4AF6A]/30">
          <CardHeader className="space-y-1 pb-4">
            <div className="flex flex-col items-center">
              <Loader2 className="w-8 h-8 text-[#D4AF6A] animate-spin mb-4" />
        ...
        <Card className="w-full max-w-md bg-[#1a1a1a]/90 backdrop-blur border-[#D4AF6A]/30">
          ...
          <CardContent className="space-y-3">
            <Button
              ...
              className="w-full bg-[#D4AF6A] hover:bg-[#C49F58] text-[#1a1a1a] font-bold"
            >
              {t('login.backToLogin')}
            </Button>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#1a1a1a] via-[#2C5F8D] to-[#1a1a1a] flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-[#1a1a1a]/90 backdrop-blur border-[#D4AF6A]/30">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardTitle className="text-2xl font-bold text-center text-[#D4AF6A]">
      ...
      <Card className="w-full max-w-md bg-[#1a1a1a]/90 backdrop-blur border-[#D4AF6A]/30">
        <CardHeader className="space-y-1 pb-4">
          <div className="flex flex-col items-center mb-4">
            <h1 className="text-4xl font-bold text-[#D4AF6A] mb-2">Maslow</h1>
          ...
          <form onSubmit={handleResetPassword} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-white/5 border-white/10 focus:border-[#D4AF6A] text-white"
                required
                minLength={6}
              />
            ...
            <Button
              type="submit"
              disabled={submitting}
              className="w-full bg-[#D4AF6A] hover:bg-[#C49F58] text-[#1a1a1a] font-bold mt-4"
            >
              {submitting ? (
