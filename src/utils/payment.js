...
export const handleStripePayment = async (tierName, price) => {
  try {
    toast({
    ...
    const paymentLink = STRIPE_PAYMENT_LINKS[tierName];
...
export const saveEmail = (email) => {
  try {
    const emails = JSON.parse(localStorage.getItem('maslowEmails') || '[]');
