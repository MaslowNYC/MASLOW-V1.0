    ...
    <section className={`relative min-h-[100dvh] w-full flex flex-col items-center justify-center py-24 overflow-hidden`}>
      ...
      <div className="relative z-20 flex flex-col items-center gap-8 max-w-md w-full px-6">
        ...
        >
          ...
          <div className={`absolute inset-0 blur-[60px] rounded-full animate-pulse ${isSanctuary ? 'bg-sky-200 opacity-40' : 'bg-[#D4AF6A] opacity-10'}`}></div>
        ...
        >
          <div>
            ...
            <div className={`w-8 h-0.5 mx-auto opacity-60 mb-8 transition-colors duration-1000 ${isSanctuary ? 'bg-[#3C5999]' : 'bg-[#D4AF6A]'}`}></div>
          </div>
            ...
            <>
              ...
              <div className="flex flex-col gap-4 w-full max-w-xs mx-auto">
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <Button
                        ...
                        className="w-full h-full bg-transparent border border-[#D4AF6A]/50 text-[#D4AF6A] hover:bg-[#D4AF6A] hover:text-[#0F172A] text-xs font-bold uppercase tracking-[0.15em] rounded-sm transition-colors duration-300 flex items-center justify-center gap-2"
                      >
                ...
                <Button
                  ...
                  className="w-full text-[#94A3B8]/30 hover:text-[#D4AF6A] text-[10px] uppercase tracking-widest h-auto py-2 p-0"
                >
