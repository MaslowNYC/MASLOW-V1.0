  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px] bg-white text-gray-900 border-none shadow-2xl rounded-xl max-h-[90vh] overflow-y-auto p-0">
        <div className="bg-[#D4AF6A] p-6 text-white text-center">
          <DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="p-6 pt-0 space-y-4">
          ...
          <div className="space-y-3 pt-2">
            <Button
              type="submit"
              className="w-full bg-[#D4AF6A] hover:bg-[#C49F58] text-white py-6 text-lg font-bold shadow-lg transition-all"
