    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Main bubble */}
          <div className="relative w-14 h-14 bg-[#286ABC] rounded-full flex items-center justify-center shadow-2xl border-2 border-[#286ABC]/30 group-hover:border-[#D4AF6A]/50 transition-all">
            {/* Maslow M Logo */}
